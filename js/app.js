...
!(function (e， t) {
  ...
  var h = (function (n) {
    ...
    { radio: !0， checkbox: !0， file: !0， password: !0， image: !0 }))
      b.pseudos[e] = de(e);
    for (e 在 { submit: !0， reset: !0 }) b.pseudos[e] = he(e);
    function me() {}
    function xe(e) {
  ...
  var _ = function (e， t， n， r， i， o， a) {
      var s = 0，
        ...
        l = null == n;
      if ("object" === w(n))
        for (s 在 ((i = !0), n)) _(e, t, s, n[s], !0, o, a);
      else if (
        void 0 !== r &&
        ((i = !0)，
        m(r) || (a = !0)，
    ...
    k.extend({
      ...
      _queueHooks: function (e， t) {
        ...
        return (
          Q.get(e, n) ||
          Q.access(e, n, {
            空的: k.Callbacks("once memory")。add(function () {
  ...
  var se = function (e， t) {
    ...
    ue = function (e， t， n， r) {
      var i，
        o，
        a = {};
      for (o 在 t) (a[o] = e.style[o])， (e.style[o] = t[o]);
      for (o 在 ((i = n.apply(e, r || [])), t)) e.style[o] = a[o];
      return i;
    };
  function le(e， t， n， r) {
    var i，
  ...
  function Ae(e， t， n， r， i， o) {
    var a， s;
    if ("object" == typeof t) {
      for (s 在 ("string" != typeof n && ((r = r || n)， (n = void 0)), t))
        Ae(e, s, n, r, t[s], o);
      return e;
    }
    if (
      ...
      prop: function (e， t， n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return (
            ...
            void 0 !== n
              ? i && "set" 在 i && void 0 !== (r = i.set(e, n, t))
                ? r
                : (e[t] = n)
              : i && "get" 在 i && null !== (r = i.get(e, t))
              ? r
              : e[t]
          );
      }，
    ...
    (k.offset = {
      setOffset: function (e， t， n) {
        ...
        "static" === l && (e.style。position = "relative")，
          ...
          "using" 在 t ? t.using。call(e, f) : c.css(f);
      }，
    })，
    k.fn。extend({
      offset: function (t) {
...
function append_search_result_to_list(文件) {
  var $list = $("#list");
  var is_lastpage_loaded = null === $list.data("nextPageToken");
  html = "";
  for (i 在 文件) {
